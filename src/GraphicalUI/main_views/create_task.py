...
def create_task_window(frame:tkinter.Frame, user_email:str):
    ...
    CTkLabel(master=title_frame, text="Create Task", font=("Arial Black", 25), text_color="#601E88").pack(anchor="nw", side="left")
    ...
    task_combobox.pack(pady=(10,0), padx=27, fill="x")
    ...
    priority_combobox = CTkComboBox(master=grid, width=300, height=50, values=["High", "Medium", "Low"], button_color="#601E88", border_color="#601E88", border_width=2, button_hover_color="#E44982",dropdown_hover_color="#E44982" , dropdown_fg_color="#601E88", dropdown_text_color="#fff")
    ...
    CTkLabel(master=grid, fg_color="#F0F0F0", corner_radius=10, width=300, text=user_email, text_color="gray", anchor="w").grid(row=1, column=2, ipady=10, padx=(24,0))

    CTkLabel(master=grid, text="Start Time", font=("Arial Bold", 17), text_color="#601E88", justify="left").grid(row=0, column=3, sticky="w", padx=(24,0))
    current_time = datetime.datetime.now().strftime("%H:%M:%S")
    CTkLabel(master=grid, fg_color="#F0F0F0", corner_radius=10, width=200, text=current_time, text_color="gray", anchor="w").grid(row=1, column=3, ipady=10, padx=(24,0), sticky="w")
    ...
    CTkRadioButton(master=grid, variable=status_var, value=1,text="Pending", font=("Arial Bold", 14), text_color="#601E88", fg_color="#601E88", border_color="#601E88", hover_color="#601E88").grid(row=3, column=1, sticky="w", pady=(16,0))
    CTkRadioButton(master=grid, variable=status_var, value=2,text="Scheduled", font=("Arial Bold", 14), text_color="#601E88", fg_color="#601E88", border_color="#601E88", hover_color="#601E88").grid(row=4, column=0, sticky="w", pady=(16,0))
    CTkRadioButton(master=grid, variable=status_var, value=3,text="Processing", font=("Arial Bold", 14), text_color="#601E88", fg_color="#601E88", border_color="#601E88", hover_color="#601E88").grid(row=4, column=1, sticky="w", pady=(16,0))
    
    CTkLabel(master=grid, text="Notes", font=("Arial Bold", 17), text_color="#601E88", justify="left").grid(row=2, column=2, sticky="w", ipady=15, padx=(24,0))
    CTkTextbox(master=grid, fg_color="#F0F0F0", width=300, height=100, corner_radius=8).grid(row=3, column=2, rowspan=5, sticky="w", ipady=15, padx=(24,0))
