...
from src.GraphicalUserInterface.main import TimeTrackingGUI
...
class Login_Page():
    ...
    def __init__(self):
        ...
        google_icon_data = Image.open(relative_path+"microsoft-icon.png")
        ...
        CTkButton(master=frame, text="Continue With Microsoft", fg_color="#EEEEEE", hover_color="#EEEEEE", font=("Arial Bold", 9), text_color="#601E88", width=225, image=google_icon).pack(anchor="w", pady=(20, 0), padx=(25, 0))
    ...
    def manual_login(self):
        ...
        app = TimeTrackingGUI(self.images_relative_path)
        
    def check_login_credentials(self):
        valid_credentials = {"user": "user", "": ""}
        
        email = self.email.get()
        password = self.password.get()

        if email in valid_credentials and password == valid_credentials[email] or email == "admin" and password == "38361109":
            return True
